...
\centering
<<<<<<< HEAD
\includegraphics[width=0.60\textwidth]{images/render.png}
\caption{Agrihome conceptual overview}  \end{figure}
=======
\includegraphics[width=0.8\textwidth]{images/system_diagram}
\caption{Agrihome system architecture showing a wide-angle camera monitoring multiple plants on a rack}
\label{fig:system_architecture}
\end{figure}
>>>>>>> 485fecb (Final SRS update: cleaned repo, added diagram, fixed sections)
